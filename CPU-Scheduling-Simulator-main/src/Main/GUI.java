...
public class GUI extends JFrame implements ActionListener {
    ...
    public static JRadioButton FCAI = new JRadioButton("FCAI");
    ...
    GUI() {
        ...
        this.setSize(800, 500);  // Regular width and height
        ...
        // Set size and color for the buttons
        Add.setPreferredSize(new Dimension(45, 20));
        Add.setBackground(Color.BLUE);  // Blue color for the + button
        Add.setForeground(Color.WHITE); // Set text color to white for visibility

        Del.setPreferredSize(new Dimension(45, 20));
        Del.setBackground(Color.RED);  // Red color for the - button
        Del.setForeground(Color.WHITE); // Set text color to white for visibility

        process.add(Add);
        process.add(Del);
        process.setBackground(new Color(0x9b4dca));  // Purple color
        ...
        FCAI.setBackground(new Color(0xe6e6e6));
